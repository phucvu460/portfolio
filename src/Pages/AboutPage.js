...
function AboutPage() {
    return (
        <div className="AboutPage">
            <Tittle title={'About Team'} span={'About Team'} />
            <ImageSection />
            ...
            <Tittle title={'General Background'} span={'Background'} />
            <div className="servives-container">
                <ServicesSection image={intelligence} title={'Artificial Intelligence'} 
                text={'Face Recognition, Object Detection, Voice Recognition, ...'}
                />
                <ServicesSection image={design} title={'Software Development'} 
                text={'Data structures & Algorithms, OS, Networking, ...'}
                />
